...
namespace kcp2k
{
    public static class Common
    {
        ...
        //static readonly RNGCryptoServiceProvider cryptoRandom = RandomNumberGenerator.Create();
        static readonly RandomNumberGenerator cryptoRandom = RandomNumberGenerator.Create();
